...
### Этапы:
1. Реализация **сеточный бот**, для личного использования с распространением уникальных доступов среди доверенных лиц. (этап обкатки и доработок. Поддержка только для ByBit)
